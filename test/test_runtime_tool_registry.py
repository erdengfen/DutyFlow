...
class TestRuntimeToolRegistry(unittest.TestCase):
    ...
    def test_runtime_registry_loads_retry_policy_fields(self) -> None:
        ...
        context_ref_spec = registry.get("read_context_ref")
        list_context_spec = registry.get("list_work_context")
        ...
        self.assertFalse(context_ref_spec.requires_approval)
        self.assertEqual(context_ref_spec.idempotency, "read_only")
        self.assertFalse(list_context_spec.requires_approval)
        self.assertEqual(list_context_spec.idempotency, "read_only")
