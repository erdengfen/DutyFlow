...
class TestCliChat(unittest.TestCase):
    ...
    def test_feishu_gm_command_calls_app_debug_entry(self) -> None:
        """CLI /feishu gm 应委托给 app 的群消息 collector 调试入口。"""
        output = CliConsole(_FakeApp()).handle_command("/feishu gm 3600")
