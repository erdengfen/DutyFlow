...
from dutyflow.agent.tools.logic.context_tools.list_work_context import ListWorkContextTool
...
TOOL_REGISTRY = {
    ...
    ListWorkContextTool.name: ListWorkContextTool(),
...
def _self_test() -> None:
    ...
    try:
        ...
        assert runtime_registry.has("list_work_context")
